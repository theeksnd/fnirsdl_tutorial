...
class Transformer(nn.Module):
    def __init__(self, embedding_dim=128, num_layers=6) -> None:
        ...
        self.project = nn.Linear(2*36, embedding_dim)
...
if __name__ == '__main__':   
    #dataset 
    freqs = [0.5, 0.7, 1.0, 0.9]
    events = "/dataset_MA/frq{}/meta_event_{}.pkl"
    meta_events = []
    for freq in freqs:
    ...
    for train_idx, test_idx in kf.split(subjects): #iterate over the subjects in a LOSO evaluation. 
        ...
        test_events = "/dataset_MA/frq{}/meta_event_{}.pkl".format(0.5, 0.5)
        ...
        if REMOVE_SUB in trained_subjects:
            print('Skipping subject:', REMOVE_SUB, 'as it was already trained on!')
            continue
        ...
        model = Transformer()
        NAME = "Transformer-x4f-loso-MA-V0-1e5"
