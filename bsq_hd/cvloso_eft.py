...
if __name__ == '__main__':   
    #dataset 
    freqs = [0.5, 0.7, 1.0]
    events = "/home/theek/ibs_dl/dataset_v2/frq{}/meta_event_{}.pkl"
    meta_events = []
    for freq in freqs:
    ...
    for REMOVE_SUB in meta_events[0].keys(): #iterate over the subjects in a LOSO evaluation. 
        ...
        stats_run = {'run-1':0, 'run-2':0, 'run-3':0}
        train_data_, validation_data = [], []
        for file in train_data:
            stats_run[files_to_sessions[file]]+=1
        ...
        test_events = "/home/theek/ibs_dl/dataset_v2/frq{}/meta_event_{}.pkl".format(0.5, 0.5)
        ...
        NAME = "Transformer_cvloseo_v0_e-7"
        ...
        for epoch in range(300):
            ...
            if np.mean(val_f1) > f1_max:
                ...
                torch.save(model.state_dict(), './models/model_{}_{}.tm'.format(NAME, REMOVE_SUB))
            ...
            plt.savefig('./loss/baseline_{}_raw_{}_lr1e_5.png'.format(NAME, REMOVE_SUB))
            plt.close()

            np.save('./loss/mats_baseline_{}_raw_{}_lr1e_5.png'.format(NAME, REMOVE_SUB), np.array(mats))
